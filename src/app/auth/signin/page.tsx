    ...
    <div className="min-h-screen bg-mist flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          <Link href="/">
            <Brand className="justify-center text-3xl" />
          </Link>
        </div>

        {/* Sign In Card */}
        <div className="bg-white rounded-lg border border-line shadow-subtle p-8">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-ink mb-2">Welcome back</h1>
            <p className="text-slate">Connect your Gmail to get started</p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-line rounded-md px-6 py-3 text-ink font-medium hover:bg-mist transition-colors disabled:opacity-50"
          >
            {loading ? (
              <>
          ...
          <div className="mt-6 space-y-2 text-center text-sm text-slate">
            ...
            <div className="flex items-center justify-center">
              <div className="w-1.5 h-1.5 bg-info rounded-full mr-2"></div>
